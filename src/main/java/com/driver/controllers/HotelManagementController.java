...
public class HotelManagementController {
    ...
    private HashMap<Integer,Integer> numberOfBookings = new HashMap<>();
    ...
    public int bookARoom(@RequestBody Booking booking){
        ...
        bookingDataBase.put(key,booking);

        hotelDataBase.put(hotelName,hotel);

        int aadharCard = booking.getBookingAadharCard();
        Integer currentBookings = numberOfBookings.get(aadharCard);
        numberOfBookings.put(aadharCard, Objects.nonNull(currentBookings)?1+currentBookings:1);
    ...
    public int getBookings(@PathVariable("aadharCard")Integer aadharCard)
    {
        ...
        return numberOfBookings.get(aadharCard);
    }
    ...
    public Hotel updateFacilities(List<Facility> newFacilities,String hotelName){
        ...
        List<Facility> oldFacilities = hotelDataBase.get(hotelName).getFacilities();
